...
; sc? : Any -> Boolean
; sc-str : StringCount -> String
; sc-count : StringCount -> Nat
; sc-temp : sc -> ?
...
; increments the count of a StringCount if the supplied string is the smae
; as the string in the StringCount
...
(define (increment-if-matches str sc)
  (if (string=? str (sc-str sc)) (make-sc (sc-str sc) (+ 1 (sc-count sc)))
      sc))
