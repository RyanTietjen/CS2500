...
; boxed-letter: Nat 1String String String String -> image
; Returns an image of a letter in a box of a given size, provided the color of the letter,
; the color of the box's background, and the color of the box's border
