...
; humble-square: Nat -> image
; counts and animates the perfect squares

(define (humble-square num)
  (overlay/align "left" "middle"
                 (text (string-append (number->string num) " squared is "
                                      (number->string (* num num))) 60 "white")
                 (rectangle 1100 100 "solid" "black")))
