...
(define (same-tree? alon1 alon2)
  (cond [(and (leaf? alon1) (leaf? alon2))
         (= (leaf-val alon1) (leaf-val alon2))]
        [(or (and (node? alon1) (leaf? alon2))
             (and (leaf? alon1) (node? alon2))) #f]
        [(or (node? alon1) (node? alon2))
         (and (same-tree? (node-left alon1) (node-left alon2))
              (same-tree? (node-right alon1) (node-right alon2)))]))
